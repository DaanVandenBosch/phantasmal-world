...
export const OP_LET = (OPCODES[0x08] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_LETI = (OPCODES[0x09] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined)],
    undefined
));
export const OP_LETB = (OPCODES[0x0a] = new_opcode(
    ...
    "letb",
    "Sets a register to the given value.",
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_BYTE, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_BYTE, undefined, undefined)],
    undefined
));
export const OP_LETW = (OPCODES[0x0b] = new_opcode(
    ...
    "letw",
    "Sets a register to the given value.",
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_WORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_WORD, undefined, undefined)],
    undefined
));
export const OP_LETA = (OPCODES[0x0c] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_POINTER, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_LETO = (OPCODES[0x0d] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_POINTER, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_LABEL, undefined, undefined)],
    undefined
));
...
export const OP_REV = (OPCODES[0x12] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.ReadWrite)] }, undefined, undefined)],
    undefined
));
...
export const OP_GGET = (OPCODES[0x17] = new_opcode(
    ...
    [new_param(TYPE_WORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_WORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_JMP_ON = (OPCODES[0x2a] = new_opcode(
    ...
    "jmp_on",
    undefined,
    [new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_REG_REF_VAR, undefined, ParamAccess.Read)],
    undefined
));
...
export const OP_JMP_E = (OPCODES[0x2c] = new_opcode(
    ...
    "jmp_=",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    undefined
));
export const OP_JMPI_E = (OPCODES[0x2d] = new_opcode(
    ...
    "jmpi_=",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    undefined
));
...
export const OP_UJMP_G = (OPCODES[0x30] = new_opcode(
    ...
    "ujmp_>",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    undefined
));
...
export const OP_SWITCH_JMP = (OPCODES[0x40] = new_opcode(
    ...
    "switch_jmp",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_I_LABEL_VAR, undefined, undefined)],
    undefined
));
...
export const OP_STACK_PUSH = (OPCODES[0x42] = new_opcode(
    ...
    "stack_push",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_STACK_POP = (OPCODES[0x43] = new_opcode(
    ...
    "stack_pop",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
export const OP_STACK_PUSHM = (OPCODES[0x44] = new_opcode(
    ...
    [new_param(TYPE_REG_REF, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, undefined)],
    undefined
));
export const OP_STACK_POPM = (OPCODES[0x45] = new_opcode(
    ...
    [new_param(TYPE_REG_REF, undefined, ParamAccess.Write), new_param(TYPE_DWORD, undefined, undefined)],
    undefined
));
...
export const OP_UNKNOWN_4F = (OPCODES[0x4f] = new_opcode(
    ...
    "unknown_4f",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_LIST = (OPCODES[0x51] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_BYTE, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_STRING, undefined, undefined)],
    StackInteraction.Pop
));
export const OP_FADEIN = (OPCODES[0x52] = new_opcode(
    0x52,
    "fadein",
    undefined,
    [],
...
export const OP_FADEOUT = (OPCODES[0x53] = new_opcode(
    0x53,
    "fadeout",
    undefined,
    [],
...
export const OP_MESEND = (OPCODES[0x5c] = new_opcode(
    0x5c,
    "mesend",
    undefined,
    [],
...
export const OP_WINEND = (OPCODES[0x5e] = new_opcode(
    0x5e,
    "winend",
    undefined,
    [],
...
export const OP_NPC_NONT = (OPCODES[0x64] = new_opcode(
    0x64,
    "npc_nont",
    undefined,
    [],
...
export const OP_NPC_TALK = (OPCODES[0x65] = new_opcode(
    0x65,
    "npc_talk",
    undefined,
    [],
...
export const OP_NPC_CRP_V3 = (OPCODES[0x66] = new_opcode(
    ...
    "npc_crp_v3",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read), new_param(TYPE_ANY, undefined, ParamAccess.Read), new_param(TYPE_ANY, undefined, ParamAccess.Read), new_param(TYPE_I_LABEL, undefined, ParamAccess.Read), new_param(TYPE_ANY, undefined, ParamAccess.Read), new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_P_HPSTAT_V3 = (OPCODES[0x69] = new_opcode(
    ...
    "p_hpstat_v3",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined)],
    StackInteraction.Pop
));
export const OP_P_DEAD_V3 = (OPCODES[0x6a] = new_opcode(
    ...
    "p_dead_v3",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_DWORD, "Player slot.", undefined)],
    StackInteraction.Pop
));
...
export const OP_P_COL = (OPCODES[0x75] = new_opcode(
    0x75,
    "p_col",
    undefined,
    [],
...
export const OP_CAM_ADJ = (OPCODES[0x81] = new_opcode(
    0x81,
    "cam_adj",
    undefined,
    [],
...
export const OP_CAM_ZMIN = (OPCODES[0x82] = new_opcode(
    0x82,
    "cam_zmin",
    undefined,
    [],
...
export const OP_POS_PIPE_V3 = (OPCODES[0x87] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "X coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Y coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Z coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_IF_ZONE_CLEAR = (OPCODES[0x88] = new_opcode(
    ...
    "if_zone_clear",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_UNHIDE_OBJ = (OPCODES[0x8a] = new_opcode(
    ...
    "unhide_obj",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_UNHIDE_ENE = (OPCODES[0x8b] = new_opcode(
    ...
    "unhide_ene",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_AT_COORDS_CALL = (OPCODES[0x8c] = new_opcode(
    ...
    "at_coords_call",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_I_LABEL, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_SET_OBJ_PARAM = (OPCODES[0x94] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "X coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Y coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Z coordinate.", ParamAccess.Read), new_param(TYPE_DWORD, "Collision radius.", ParamAccess.Read), new_param(TYPE_I_LABEL, "Function label.", ParamAccess.Read), new_param(TYPE_DWORD, "Vertical position of the cursor.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, "Object handle.", undefined)],
    undefined
));
export const OP_SET_FLOOR_HANDLER = (OPCODES[0x95] = new_opcode(
    ...
    "set_floor_handler",
    undefined,
    [new_param(TYPE_DWORD, "Floor number.", undefined), new_param(TYPE_I_LABEL, "Handler function label.", undefined)],
    StackInteraction.Pop
));
...
export const OP_HUD_HIDE = (OPCODES[0x98] = new_opcode(
    0x98,
    "hud_hide",
    undefined,
    [],
...
export const OP_HUD_SHOW = (OPCODES[0x99] = new_opcode(
    0x99,
    "hud_show",
    undefined,
    [],
...
export const OP_DEL_OBJ_PARAM = (OPCODES[0xb2] = new_opcode(
    ...
    "del_obj_param",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, "Object handle.", undefined)],
    undefined
));
...
export const OP_ITEM_DELETE2 = (OPCODES[0xb6] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_PL_PKOFF = (OPCODES[0xc3] = new_opcode(
    0xc3,
    "pl_pkoff",
    undefined,
    [],
...
export const OP_SET_QUEST_BOARD_HANDLER = (OPCODES[0xcb] = new_opcode(
    ...
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_STRING, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_PL_PKON = (OPCODES[0xd0] = new_opcode(
    0xd0,
    "pl_pkon",
    undefined,
    [],
...
export const OP_LOAD_PVR = (OPCODES[0xdc] = new_opcode(
    0xdc,
    "load_pvr",
    undefined,
    [],
...
export const OP_UNKNOWN_DE = (OPCODES[0xde] = new_opcode(
    ...
    "unknown_de",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_WARP_ON = (OPCODES[0xe4] = new_opcode(
    0xe4,
    "warp_on",
    undefined,
    [],
...
export const OP_WARP_OFF = (OPCODES[0xe5] = new_opcode(
    0xe5,
    "warp_off",
    undefined,
    [],
...
export const OP_SET_EVENTFLAG2 = (OPCODES[0xe8] = new_opcode(
    ...
    "set_eventflag2",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_SET_CHAT_CALLBACK = (OPCODES[0xf801] = new_opcode(
    ...
    "set_chat_callback",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_STRING, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_GO_FLOOR = (OPCODES[0xf828] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Floor ID.", ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_IF_SWITCH_NOT_PRESSED = (OPCODES[0xf82d] = new_opcode(
    ...
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
export const OP_IF_SWITCH_PRESSED = (OPCODES[0xf82e] = new_opcode(
    ...
    "if_switch_pressed",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Floor ID.", ParamAccess.Read), new_param(TYPE_DWORD, "Switch ID.", ParamAccess.Read), new_param(TYPE_DWORD, "Will be set to 1 if the switch is pressed, 0 otherwise.", ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_CONTROL_DRAGON = (OPCODES[0xf830] = new_opcode(
    ...
    "control_dragon",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_SHRINK = (OPCODES[0xf838] = new_opcode(
    ...
    "shrink",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_UNKNOWN_F868 = (OPCODES[0xf868] = new_opcode(
    ...
    "unknown_f868",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_GET_GENDER = (OPCODES[0xf879] = new_opcode(
    ...
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player gender.", ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_GET_RANDOM = (OPCODES[0xf89a] = new_opcode(
    ...
    "get_random",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read), new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_READ1 = (OPCODES[0xf8b0] = new_opcode(
    0xf8b0,
    "read1",
    "Reads a 1-byte value from an arbitrary location.",
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_BYTE, undefined, ParamAccess.Write)] }, "Register to store the result to.", undefined), new_param(TYPE_DWORD, "Address to read from.", undefined)],
    undefined
));
export const OP_READ2 = (OPCODES[0xf8b1] = new_opcode(
    0xf8b1,
    "read2",
    "Reads a 2-byte value from an arbitrary location.",
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_WORD, undefined, ParamAccess.Write)] }, "Register to store the result to.", undefined), new_param(TYPE_DWORD, "Address to read from.", undefined)],
    undefined
));
export const OP_READ4 = (OPCODES[0xf8b2] = new_opcode(
    0xf8b2,
    "read4",
    "Reads a 4-byte value from an arbitrary location.",
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, "Register to store the result to.", undefined), new_param(TYPE_DWORD, "Address to read from.", undefined)],
    undefined
));
export const OP_WRITE1 = (OPCODES[0xf8b3] = new_opcode(
    0xf8b3,
    "write1",
    "Writes a 1-byte value to an arbitrary location.",
    [new_param(TYPE_DWORD, "Address to write to.", undefined), new_param(TYPE_BYTE, "Value to be written.", undefined)],
    StackInteraction.Pop
));
export const OP_WRITE2 = (OPCODES[0xf8b4] = new_opcode(
    0xf8b4,
    "write2",
    "Writes a 2-byte value to an arbitrary location.",
    [new_param(TYPE_DWORD, "Address to write to.", undefined), new_param(TYPE_WORD, "Value to be written.", undefined)],
    StackInteraction.Pop
));
export const OP_WRITE4 = (OPCODES[0xf8b5] = new_opcode(
    0xf8b5,
    "write4",
    "Writes a 4-byte value to an arbitrary location.",
    [new_param(TYPE_DWORD, "Address to write to.", undefined), new_param(TYPE_DWORD, "Value to be written.", undefined)],
    StackInteraction.Pop
));
...
export const OP_QEXIT = (OPCODES[0xf8c6] = new_opcode(
    0xf8c6,
    "qexit",
    undefined,
    [],
...
export const OP_USE_ANIMATION = (OPCODES[0xf8c7] = new_opcode(
    ...
    "use_animation",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Animation ID.", ParamAccess.Read), new_param(TYPE_DWORD, "Animation duration in number of frames.", ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_SET_SLOT_INVINCIBLE = (OPCODES[0xf8ca] = new_opcode(
    ...
    "set_slot_invincible",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, "Player slot.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_UNKNOWN_F8DB = (OPCODES[0xf8db] = new_opcode(
    ...
    "unknown_f8db",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_WORD, undefined, undefined)],
    StackInteraction.Pop
));
export const OP_NPC_ACTION_STRING = (OPCODES[0xf8dc] = new_opcode(
    ...
    "npc_action_string",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_S_LABEL, undefined, undefined)],
    undefined
));
...
export const OP_LOAD_UNK_DATA = (OPCODES[0xf8f2] = new_opcode(
    ...
    "load_unk_data",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_D_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
export const OP_PARTICLE2 = (OPCODES[0xf8f3] = new_opcode(
    ...
    "particle2",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_FLOAT, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_DEC2FLOAT = (OPCODES[0xf901] = new_opcode(
    ...
    "dec2float",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_FLOAT, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_FLOAT2DEC = (OPCODES[0xf902] = new_opcode(
    ...
    "float2dec",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_FLOAT, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_FLET = (OPCODES[0xf903] = new_opcode(
    ...
    "flet",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_FLOAT, undefined, ParamAccess.Write)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_FLOAT, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
export const OP_FLETI = (OPCODES[0xf904] = new_opcode(
    ...
    "fleti",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_FLOAT, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_FLOAT, undefined, undefined)],
    undefined
));
...
export const OP_GET_UNKNOWN_COUNT = (OPCODES[0xf910] = new_opcode(
    ...
    "get_unknown_count",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_SET_PALETTEX_CALLBACK = (OPCODES[0xf914] = new_opcode(
    ...
    undefined,
    [new_param(TYPE_DWORD, "Player slot.", undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_GET_PALETTEX_ACTIVATED = (OPCODES[0xf919] = new_opcode(
    ...
    undefined,
    [new_param(TYPE_DWORD, "Player slot.", undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_GET_COORD_PLAYER_DETECT = (OPCODES[0xf924] = new_opcode(
    ...
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, "Player slot.", ParamAccess.Read)] }, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Read)] }, undefined, undefined)],
    undefined
));
...
export const OP_FLOOR_PLAYER_DETECT = (OPCODES[0xf928] = new_opcode(
    ...
    "floor_player_detect",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write), new_param(TYPE_DWORD, undefined, ParamAccess.Write), new_param(TYPE_DWORD, undefined, ParamAccess.Write), new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined)],
    undefined
));
...
export const OP_COLOR_CHANGE = (OPCODES[0xf92d] = new_opcode(
    ...
    "color_change",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_CHAT_BOX = (OPCODES[0xf930] = new_opcode(
    ...
    "chat_box",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_STRING, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_GET_ITEM_INFO = (OPCODES[0xf93a] = new_opcode(
    ...
    "get_item_info",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_ANY, undefined, ParamAccess.Write)] }, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_PREPARE_STATISTIC = (OPCODES[0xf93e] = new_opcode(
    ...
    "prepare_statistic",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_KEYWORD = (OPCODES[0xf940] = new_opcode(
    ...
    "keyword",
    undefined,
    [new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_DWORD, "Player slot.", undefined), new_param(TYPE_STRING, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_BB_MAP_DESIGNATE = (OPCODES[0xf951] = new_opcode(
    ...
    "bb_map_designate",
    undefined,
    [new_param(TYPE_BYTE, undefined, undefined), new_param(TYPE_WORD, undefined, undefined), new_param(TYPE_BYTE, undefined, undefined), new_param(TYPE_BYTE, undefined, undefined)],
    undefined
));
...
export const OP_BB_SWAP_ITEM = (OPCODES[0xf953] = new_opcode(
    ...
    "bb_swap_item",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_BB_EXCHANGE_PD_ITEM = (OPCODES[0xf955] = new_opcode(
    ...
    "bb_exchange_pd_item",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
export const OP_BB_EXCHANGE_PD_SRANK = (OPCODES[0xf956] = new_opcode(
    ...
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_BB_EXCHANGE_SLT = (OPCODES[0xf95c] = new_opcode(
    ...
    "bb_exchange_slt",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param({ kind: Kind.RegTupRef, register_tuples: [new_param(TYPE_DWORD, undefined, ParamAccess.Write)] }, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined), new_param(TYPE_I_LABEL, undefined, undefined)],
    StackInteraction.Pop
));
...
export const OP_BB_BOX_CREATE_BP = (OPCODES[0xf95e] = new_opcode(
    ...
    "bb_box_create_bp",
    undefined,
    [new_param(TYPE_DWORD, undefined, undefined), new_param(TYPE_FLOAT, undefined, undefined), new_param(TYPE_FLOAT, undefined, undefined)],
    StackInteraction.Pop
));
