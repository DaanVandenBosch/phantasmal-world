...
export const OP_WRITE1 = (OPCODES[0xf8b3] = new_opcode(
    ...
    [
        new_param(TYPE_DWORD, "Address to write to.", undefined),
        new_param(TYPE_BYTE, "Value to be written.", undefined),
    ],
    StackInteraction.Pop,
));
export const OP_WRITE2 = (OPCODES[0xf8b4] = new_opcode(
    ...
    [
        new_param(TYPE_DWORD, "Address to write to.", undefined),
        new_param(TYPE_WORD, "Value to be written.", undefined),
    ],
    StackInteraction.Pop,
));
export const OP_WRITE4 = (OPCODES[0xf8b5] = new_opcode(
    ...
    [
        new_param(TYPE_DWORD, "Address to write to.", undefined),
        new_param(TYPE_DWORD, "Value to be written.", undefined),
    ],
    StackInteraction.Pop,
));
